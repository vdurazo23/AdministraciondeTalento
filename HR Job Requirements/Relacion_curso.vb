...
Public Class Relacion_curso
    ...
    Private Sub Btn_puesto_tope_Click(sender As Object, e As EventArgs) Handles Btn_puesto_tope.Click
        ...
        Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
            ...
            Dim vencimiento As Boolean = CheckBox2.Checked
            ...
            If Nuevo Then
                ...
                If cmb_rel.SelectedItem.ToString = "Por Nivel" Then
                    ...
                    Dim re = SqlQuery.agregar_relacion_curso(CU_CODIGO, solicitado, PEMPLEADO, PNIVEL, idni, PPUESTO, escalona, hereda, puesto_inicial, puesto_final, activo, Nuevo, Nothing, Nothing, id_ponderacion)
                    If re = 1 Then
                    ...
                    If seleccionados.Count > 0 Then
                        If seleccionados.Count > 1 Then
                            ...
                            If MsgBox("Al ser una selección multiple, las relaciones repetidas solamente se saltaran", MsgBoxStyle.Information + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                                ree = SqlQuery.agregar_relacion_multiple_curso(CU_CODIGO, solicitado, PEMPLEADO, PPUESTO, seleccionados, seleccionados_codigos, activo, Nuevo, id_ponderacion)
                            End If

                        Else
                            ree = SqlQuery.agregar_relacion_curso(CU_CODIGO, solicitado, PEMPLEADO, PNIVEL, idni, PPUESTO, escalona, hereda, seleccionados(0).pu_codigo, puesto_final, activo, Nuevo, Nothing, Nothing, id_ponderacion)
                        End If
                    End If
                    If ree = 1 Then
                        Me.DialogResult = DialogResult.OK
                ...
                Else
                    PEMPLEADO = True
                    Dim re = SqlQuery.agregar_relacion_multiple_curso(CU_CODIGO, solicitado, True, False, seleccionados, seleccionados_codigos, activo, Nuevo, id_ponderacion)
